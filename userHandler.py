...
class UserData:
	...
	def extractData(self):
		with open('C:\\Users\\KAMALESH DRAN\\PycharmProjects\\finalproj\\userData\\userData.pck', 'rb') as file:
	...
	def updateData(self, name, gender, userphoto):
		with open('C:\\Users\\KAMALESH DRAN\\PycharmProjects\\finalproj\\userData\\userData.pck', 'wb') as file:
