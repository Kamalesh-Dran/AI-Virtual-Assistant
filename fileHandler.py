...
def createFile(text):
    ...
    if isContain(text, ["ppt", "power point", "powerpoint"]):
        ...
        appLocation = "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\POWERPNT.exe"

    elif isContain(text, ['excel', 'spreadsheet']):
        file_name = "sample_file.xsl"
        appLocation = "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\EXCEL.EXE"

    elif isContain(text, ['word', 'document']):
        file_name = "sample_file.docx"
        appLocation = "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\WINWORD.EXE"
